...
public class UploadController {
	...
	public Result<String> uploadPhoto(@RequestParam(name="photo",required=true)MultipartFile photo){
		...
		if(photo.getSize()/1024 > uploadPhotoMaxSize){
			...
			codeMsg.setMsg("The size of the picture cannot exceed" + (uploadPhotoMaxSize/1024) + "M");
		...
		log.info("Picture uploaded successfully, save location:" + uploadPhotoPath +filename);
