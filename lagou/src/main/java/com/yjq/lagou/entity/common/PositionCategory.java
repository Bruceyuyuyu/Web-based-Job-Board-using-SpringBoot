...
public class PositionCategory extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredMaxLength=true,requiredMinLength=true,minLength=1,maxLength=128,errorRequiredMsg="职位类别名称不能为空!",errorMinLengthMsg="职位类别名称长度需大于0!",errorMaxLengthMsg="职位类别名称长度不能大于128!")
