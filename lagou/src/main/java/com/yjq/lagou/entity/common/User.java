...
public class User extends BaseEntity{
	...
	private static final String DEFAULT_WORK_EXPERIENCE = "Fresh graduates"; //默认工作经验
	...
	@ValidateEntity(required=true,errorRequiredMsg="User email address cannot be empty!")
