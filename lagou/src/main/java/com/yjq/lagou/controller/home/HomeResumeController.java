...
import com.yjq.lagou.entity.home.*;
...
import com.yjq.lagou.service.home.*;
...
public class HomeResumeController {
	...
	public Result<Boolean> saveWorkExperienceForm(WorkExperience workExperience,HttpServletRequest request)
	{
		...
		//检查开始时间是否为空
		if(workExperience.getStartYear() == null || workExperience.getStartMonth() == null || "Starting year".equals(workExperience.getStartYear()) || "Starting month".equals(workExperience.getStartMonth())) {
			return Result.error(CodeMsg.RESUME_WORK_EXPERIENCE_START_TIME_EMPTY);
		}
		//检查结束时间是否为空
		if(workExperience.getEndYear() == null || workExperience.getEndMonth() == null || "End year".equals(workExperience.getEndYear()) || "End month".equals(workExperience.getEndMonth())) {
	...
	public Result<Boolean> saveProjectExperienceForm(ProjectExperience projectExperience,HttpServletRequest request)
	{
		...
		//检查开始时间是否为空
		if(projectExperience.getStartYear() == null || projectExperience.getStartMonth() == null || "Starting year".equals(projectExperience.getStartYear()) || "Starting month".equals(projectExperience.getStartMonth())) {
			return Result.error(CodeMsg.RESUME_PROJECT_EXPERIENCE_START_TIME_EMPTY);
		}
		//检查结束时间是否为空
		if(projectExperience.getEndYear() == null || projectExperience.getEndMonth() == null || "End year".equals(projectExperience.getEndYear()) || "End month".equals(projectExperience.getEndMonth())) {
	...
	public Result<Boolean> saveEducationBackgroundForm(EducationBackground educationBackground,HttpServletRequest request)
	{
		...
		//检查开始年份是否为空
		if(educationBackground.getStartYear() == null || "Starting year".equals(educationBackground.getStartYear())) {
			return Result.error(CodeMsg.RESUME_EDUCATION_BACKGROUND_START_TIME_EMPTY);
		}
		//检查结束年份是否为空
		if(educationBackground.getEndYear() == null || "End year".equals(educationBackground.getEndYear())) {
