    ...
    <div id="container">
            ...
            <div class="content_l">
                <dl class="job_detail">
                    ...
                    <dd class="job_bt">
                        <h3 class="description">Company products</h3>
                    	<p><font size="3"><b>Product Name:</b></font><br>
                       			${Company.productTitle!""}
                   		</p>
                       	<p><font size="3"><b>Product images:</b></font><br>
                       	<img src="/photo/view?filename=${Company.productPhoto!"common/product_default.png"}" width="600" height="350">
                       	</p>
                       	<p><font size="3"><b>Product Introduction:</b></font><br>
